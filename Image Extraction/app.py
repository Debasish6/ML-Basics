...
from Find_Similar_image_haystack import MultimodalImageSearch
...
def main():
    st.markdown("<h1 style='text-align: center; color: green;'>Search App</h1>", unsafe_allow_html=True)

    multimodal_search = MultimodalImageSearch()
